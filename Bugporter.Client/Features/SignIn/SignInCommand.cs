...
namespace Bugporter.Client.Features.SignIn
{
    public class SignInCommand : AsyncCommandBase
    {
        ...
        public SignInCommand(SignInFormViewModel viewModel, FirebaseAuthClient authClient, CurrentUserStore currentUserStore)
        {
        ...
        protected override async Task ExecuteAsync(object parameter)
        {
            try
            {
                ...
                _currentUserStore.User = userCredential.User;
